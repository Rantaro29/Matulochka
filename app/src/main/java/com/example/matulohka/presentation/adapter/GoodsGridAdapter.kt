...
import com.example.matulohka.databinding.FragmentGoodsGridItemBinding
import com.example.matulohka.databinding.FragmentGoodsItemBinding
import com.squareup.picasso.Picasso

class GoodsGridAdapter(
    private val values: List<GoodsModel>, private val context: Context?
) : RecyclerView.Adapter<GoodsGridAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        return ViewHolder(
            FragmentGoodsGridItemBinding.inflate(
    ...
    inner class ViewHolder(binding: FragmentGoodsGridItemBinding) : RecyclerView.ViewHolder(binding.root) {
